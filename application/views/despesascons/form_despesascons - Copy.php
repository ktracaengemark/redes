							...
							<div class="panel panel-primary">
								...
								<div id="collapse1" class="panel-collapse" role="tabpanel" aria-labelledby="heading1" aria-expanded="false">
									<div class="panel-body">
										...
										<?php if ($metodo > 1) { ?>
										<input type="hidden" name="idApp_ServicoCompracons<?php echo $i ?>" value="<?php echo $servico[$i]['idApp_ServicoCompracons']; ?>"/>
										<?php } ?>
										...
										<?php if ($metodo > 1) { ?>
										<input type="hidden" name="idApp_ProdutoCompracons<?php echo $i ?>" value="<?php echo $produto[$i]['idApp_ProdutoCompracons']; ?>"/>
										<?php } ?>
...
-->
						...
						<div class="form-group">
							<div class="row">
								...
								<input type="hidden" name="idApp_Despesascons" value="<?php echo $despesas['idApp_Despesascons']; ?>">
								<?php if ($metodo > 1) { ?>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<div class="col-md-6 text-right">
														<a class="btn btn-danger" href="<?php echo base_url() . 'despesascons/excluir/' . $despesas['idApp_Despesascons'] ?>" role="button">
