	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="panel-heading text-center">
				<h2><?php echo '<strong>' . $_SESSION['Despesas']['NomeEmpresa'] . '</strong> - <strong>DEVOLUÇÃO</strong> - <strong>Nº: ' . $_SESSION['Despesas']['idApp_Despesascons'] . '</strong>' ?></h2>
			</div>
			...
			<div class="panel-body">				
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>								
							<!--<td><?php echo $produto[$i]['idApp_Despesascons'] ?></td>-->
							<td><?php echo $produto[$i]['idApp_ProdutoCompracons'] ?></td>
