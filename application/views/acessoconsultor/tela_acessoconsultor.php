			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="col-md-12 text-center t">
						<h1><?php echo '<small>Bem Vindo(a)<br> </small><strong>"' . $_SESSION['log']['NomeConsultor'] . '"</strong>'  ?></h1>
					</div>

					<div class="col-md-12 text-center t">
						<h1><?php echo '<small>Consultor(a) da Empresa<br></small><strong> ' . $_SESSION['log']['NomeEmpresa'] . '</strong>.'  ?></h1>
					</div>
