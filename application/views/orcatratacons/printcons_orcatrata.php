	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="panel-heading text-center">
				<h3><?php echo '<strong>' . $_SESSION['Consultor']['NomeEmpresa'] . '</strong> - <strong>ORÇAMENTO</strong> - <strong>Nº: ' . $_SESSION['Orcatrata']['idApp_OrcaTrataCons'] . '</strong>' ?></h3>
			</div>
			...
			<div class="panel-body">
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<!--<td><?php echo $servico[$i]['idApp_OrcaTrataCons'] ?></td>-->
