	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="panel-body">
				...
				<hr />
				<?php echo '<h4>Cliente: ' . $_SESSION['Cliente']['NomeCliente'] . ' - Id: ' . $_SESSION['Cliente']['idApp_Cliente'] . ' - <strong>ORÇAMENTO</strong> - <strong>Nº: ' . $_SESSION['Orcatrata']['idApp_OrcaTrataCons'] . '</strong></h4>' ?>
				<hr />
