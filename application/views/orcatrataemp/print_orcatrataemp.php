	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="panel-body">
				...
				<hr />
				<?php echo '<h4>Usuario: ' . $_SESSION['Usuario']['Nome'] . ' - Id: ' . $_SESSION['Usuario']['idSis_Usuario'] . ' - <strong>ORÇAMENTO</strong> - <strong>Nº: ' . $_SESSION['Orcatrata']['idApp_OrcaTrataEmp'] . '</strong></h4>' ?>
				<hr />
