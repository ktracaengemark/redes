			...
			<div class="col-md-12">
				...
				<div class="col-md-6">	
					<div class="panel panel-primary">
						...
						<div class="panel-heading"> Como <strong>Receber</strong> sua Comissão:</div>
							...
							<div class="form-group">
								<div class="row">								
									...
									<div class="col-md-12">																			
										...
										<div class="form-group col-md-12 text-left">														
											<div class="row">	
												<a  class="btn btn-lg btn-info btn-block" href="<?php echo base_url() ?>relatorioconsultor/associado" role="button"> 
													<span class="glyphicon glyphicon-list"></span> Cadastro de Indicações
												</a>
											</div>
										</div>	
									</div>
				...
				<div class="col-md-6">
					<div class="panel panel-danger">
						...
						<div class="panel-heading"> Como <strong>Pagar </strong>sua Manutençao:</div>
						<div class="panel-body">
							<div class="form-group">
								<div class="row">														
