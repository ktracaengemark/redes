	...
	<div class="col-md-8">
		<div class="row">
			<div class="col-md-12">
				...
				<?php echo form_open('relatorioconsultor/admin', 'role="form"'); ?>
							...
							<div class="form-group">
								<div class="row">														
									...
									<div class="col-md-12">
										...
										<div class="form-group col-md-12 text-left">
											<div class="row">																				
												<a class="btn btn-md btn-success btn-block" href="<?php echo base_url() ?>relatorioconsultor/clientes" role="button"> 
										...
										<div class="form-group col-md-12 text-left">	
											<div class="row">		
												<a class="btn btn-md btn-success btn-block" href="<?php echo base_url() ?>relatorioconsultor/fornecedor" role="button"> 
									...
									<div class="col-md-12">										
										...
										<div class="form-group col-md-12 text-left">
											<div class="row">		
												<a class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatorioconsultor/produtos" role="button"> 
									...
									<div class="col-md-12">
										...
										<div class="form-group col-md-12 text-left">
											<div class="row">		
												<a type="button" class="btn btn-md btn-warning btn-block" href="<?php echo base_url() ?>relatorioconsultor/orcamentopc" role="button"> 
								...
								<div class="form-group">
									<div class="row">								
										<div class="col-md-12">											
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatorioconsultor/orcamento" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">										
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatorioconsultor/receitas" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatorioconsultor/despesas" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatorioconsultor/balanco" role="button"> 
										...
										<div class="col-md-12">											
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatorioconsultor/produtoscomp" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatorioconsultor/produtosvend" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatorioconsultor/produtosdevol" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatorioconsultor/consumo" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatorioconsultor/estoque" role="button"> 
							...
							<div class="form-group">
								<div class="row">								
									...
									<div class="col-md-12">																			
										...
										<div class="form-group col-md-12 text-left">														
											<div class="row">	
												<a  class="btn btn-md btn-danger btn-block" href="<?php echo base_url() ?>relatorioconsultor/empresaassociado" role="button"> 
								...
								<div class="form-group">
									<div class="row">								
										<div class="col-md-12">											
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatorioconsultor/servicosprest" role="button"> 
