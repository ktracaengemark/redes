			...
			<div class="main">
				...
				<div class="panel panel-primary">
					<div class="panel-heading"><strong><?php echo $titulo; ?></strong>
						...
						<?php echo form_open('relatorioconsultor/clientesusuario', 'role="form"'); ?>
						...
						<a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>clienteusuario/cadastrar" role="button"> 
