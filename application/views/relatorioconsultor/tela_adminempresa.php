									...
									<div class="row">														
										...
										<div class="col-md-10">
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">																				
													<a class="btn btn-md btn-success" href="<?php echo base_url() ?>relatorioconsultor/clientes" role="button"> 
											...
											<div class="form-group col-md-10 text-left">	
												<div class="row">		
													<a class="btn btn-md btn-success" href="<?php echo base_url() ?>relatorioconsultor/funcionario" role="button"> 
											...
											<div class="form-group col-md-10 text-left">	
												<div class="row">		
													<a class="btn btn-md btn-success" href="<?php echo base_url() ?>relatorioconsultor/fornecedor" role="button"> 
										...
										<div class="col-md-10">											
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">													
													<a class="btn btn-md btn-info" href="<?php echo base_url() ?>relatorioconsultor/clientes" role="button"> 
								...
								<div class="form-group">
									<div class="row">								
										<div class="col-md-10">											
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info" href="<?php echo base_url() ?>relatorioconsultor/orcamento" role="button"> 
														<span class="glyphicon glyphicon-usd"></span> Orçamentos
													</a>											
												</div>	
											</div>											
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info" href="<?php echo base_url() ?>relatorioconsultor/despesas" role="button"> 
														<span class="glyphicon glyphicon-usd"></span> Despesas
													</a>
												</div>	
											</div>											
											<div class="form-group col-md-10 text-left">
												<div class="row">										
													<a  type="button" class="btn btn-md btn-info" href="<?php echo base_url() ?>relatorioconsultor/receitas" role="button"> 
										...
										<div class="col-md-10">											
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatorioconsultor/produtos" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatorioconsultor/produtoscomp" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatorioconsultor/produtosvend" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatorioconsultor/consumo" role="button"> 
										...
										<div class="col-md-10">
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-warning" href="<?php echo base_url() ?>relatorioconsultor/servicosprest" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-warning" href="<?php echo base_url() ?>relatorioconsultor/orcamentopc" role="button"> 
