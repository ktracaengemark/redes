...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <meta http-equiv="refresh" content="<?php echo $tempo+1; ?>;<?php echo base_url(); ?>loginempresamatriz/sair/FALSE"/>
        ...
        <title><?php echo $_SESSION['log']['UsuarioEmpresaMatriz'] ?> - Rede Calisi</title>        
