						...
						<li class="btn-toolbar navbar-form" role="toolbar" aria-label="...">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li role="separator" class="divider"></li>
									-->
									<li><a href="<?php echo base_url(); ?>logincliente/sair"><span class="glyphicon glyphicon-log-out"></span> Sair</a></li>
								</ul>
							</div>
							
							<div class="btn-group">
								<button type="button" class="btn btn-md btn-success dropdown-toggle" data-toggle="dropdown">
									<span class="glyphicon glyphicon-user"></span> Contatos <span class="caret"></span>
								</button>
								<ul class="dropdown-menu" role="menu">
						...
						<li class="btn-toolbar navbar-form" role="toolbar" aria-label="...">
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">							
									...
									<li role="separator" class="divider"></li>-->
									<li><a href="<?php echo base_url() ?>orcatrata2/cadastrar"><span class="glyphicon glyphicon-usd"></span> Receitas/Controle pessoal</a></li>
									<li role="separator" class="divider"></li>							
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="<?php echo base_url() ?>relatorio/orcamento"><span class="glyphicon glyphicon-list"></span> Receitas/Controle Pessoal</a></li>
									<li role="separator" class="divider"></li>
									<li><a href="<?php echo base_url() ?>relatorio/receitas"><span class="glyphicon glyphicon-list"></span> Orç.  X Pag.</a></li>							
									<!--<li role="separator" class="divider"></li>
