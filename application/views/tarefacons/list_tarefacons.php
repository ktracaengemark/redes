<div class="container-fluid">
	...
	<div class="form-group">
		<div class="row">			
			<a class="btn btn-lg btn-warning" href="<?php echo base_url() ?>tarefacons/cadastrar" role="button"> 
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="proxima">
                    ...
                    <div class="bs-callout bs-callout-success" id=callout-overview-not-both>
                        ...
                        <a class="btn btn-success" href="<?php echo base_url() . 'tarefacons/alterar/' . $row['idApp_Tarefacons'] ?>" role="button">
                        ...
                        <h4>
							<p>
								<span class=""></span> <b>Tarefa:</b> <?php echo $row['idApp_Tarefacons']; ?>
                            </p>
							<p>
                ...
                <div role="tabpanel" class="tab-pane active" id="anterior">
                    ...
                    <div class="bs-callout bs-callout-danger" id=callout-overview-not-both>
                        ...
                        <a class="btn btn-danger" href="<?php echo base_url() . 'tarefacons/alterar/' . $row['idApp_Tarefacons'] ?>" role="button">
                            <span class="glyphicon glyphicon-edit"></span> Editar Dados
                        </a>
