	...
	<div class="row">			
		...
		<div class="col-sm-7 col-sm-offset-3 col-md-10 col-md-offset-2 main">												
			<div class="col-md-12 text-center t">
				...
				<div class="row">	
					<a class="btn btn-lg btn-success" href="<?php echo base_url() ?>relatorioconsultor/tarefa" role="button"> 
			...
			<div class="panel panel-<?php echo $panel; ?>">
				...
				<div class="panel-heading"><strong></strong>
						<div class="text-left ">											
							...
							<a class="btn btn-md btn-success" href="<?php echo base_url() ?>relatorioconsultor/tarefa" role="button"> 
								<span class="glyphicon glyphicon-list"></span> Listar
							</a>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<div class="col-md-6 text-right">
													<a class="btn btn-danger" href="<?php echo base_url() . 'tarefacons/excluir/' . $tarefa['idApp_Tarefacons'] ?>" role="button">
														<span class="glyphicon glyphicon-trash"></span> Confirmar Exclusão
													</a>
												</div>
											</div>
