	...
	<div class="col-md-8">
		<div class="row">
			<div class="col-md-12">
				...
				<?php echo form_open('relatoriofuncionario/admin', 'role="form"'); ?>
							...
							<div class="form-group">
								<div class="row">														
									...
									<div class="col-md-12">
										...
										<div class="form-group col-md-12 text-left">
											<div class="row">																				
												<a class="btn btn-md btn-success btn-block" href="<?php echo base_url() ?>relatoriofuncionario/clientes" role="button"> 
										...
										<div class="form-group col-md-12 text-left">	
											<div class="row">		
												<a class="btn btn-md btn-success btn-block" href="<?php echo base_url() ?>relatoriofuncionario/fornecedor" role="button"> 
									...
									<div class="col-md-12">										
										...
										<div class="form-group col-md-12 text-left">
											<div class="row">		
												<a class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatoriofuncionario/produtos" role="button"> 
									...
									<div class="col-md-12">
										...
										<div class="form-group col-md-12 text-left">
											<div class="row">		
												<a type="button" class="btn btn-md btn-warning btn-block" href="<?php echo base_url() ?>relatoriofuncionario/orcamentopc" role="button"> 
								...
								<div class="form-group">
									<div class="row">								
										<div class="col-md-12">											
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatoriofuncionario/orcamento" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">										
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatoriofuncionario/receitas" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatoriofuncionario/despesas" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info btn-block" href="<?php echo base_url() ?>relatoriofuncionario/balanco" role="button"> 
										...
										<div class="col-md-12">											
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatoriofuncionario/produtoscomp" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatoriofuncionario/produtosvend" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatoriofuncionario/produtosdevol" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatoriofuncionario/consumo" role="button"> 
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatoriofuncionario/estoque" role="button"> 
							...
							<div class="form-group">
								<div class="row">								
									...
									<div class="col-md-12">																			
										...
										<div class="form-group col-md-12 text-left">														
											<div class="row">	
												<a  class="btn btn-md btn-danger btn-block" href="<?php echo base_url() ?>relatoriofuncionario/empresaassociado" role="button"> 
								...
								<div class="form-group">
									<div class="row">								
										<div class="col-md-12">											
											...
											<div class="form-group col-md-12 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-primary btn-block" href="<?php echo base_url() ?>relatoriofuncionario/servicosprest" role="button"> 
