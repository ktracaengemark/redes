			...
			<div class="main">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('relatoriofuncionario/despesas', 'role="form"'); ?>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-2">
									...
									<select data-placeholder="Selecione uma opção..." class="form-control Chosen"
											id="Categoriadesp" name="Categoriadesp">
										<?php
										foreach ($select['Categoriadesp'] as $key => $row) {
											if ($query['Categoriadesp'] == $key) {
												echo '<option value="' . $key . '" selected="selected">' . $row . '</option>';
											} else {
												echo '<option value="' . $key . '">' . $row . '</option>';
											}
								...
								<div class="col-md-2">
									<label for="AprovadoDespesas">Desp. Aprov./Fech.?</label>
									<select data-placeholder="Selecione uma opção..." class="form-control Chosen"
