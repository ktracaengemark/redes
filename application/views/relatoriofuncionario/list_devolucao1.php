            ...
            <table class="table table-bordered table-condensed table-striped">
				...
				<tbody>
                    ...
                    foreach ($report->result_array() as $row) {
                        #echo '<tr>';
                        echo '<tr class="clickable-row" data-href="' . base_url() . 'orcatratadevcons/alterar/' . $row['idApp_OrcaTrataCons'] . '">';
                            ...
                            echo '<td class="notclickable">
                                    <a class="btn btn-md btn-info notclickable" target="_blank" href="' . base_url() . 'OrcatrataPrintDevcons/imprimir/' . $row['idApp_OrcaTrataCons'] . '">
