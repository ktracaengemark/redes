		...
		<div class="col-md-8 ">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('relatoriofuncionario/servicos', 'role="form"'); ?>

						<div class="form-group">
							<div class="row">
								
								<div class="col-md-6">
									<label for="Ordenamento">Servicos</label>
							...
							<div class="row">		
								...
								<div class="col-md-8 ">									
									...
									<div class="col-md-6 text-right">											
											<a class="btn btn-lg btn-danger" href="<?php echo base_url() ?>servicos/cadastrar" role="button"> 
