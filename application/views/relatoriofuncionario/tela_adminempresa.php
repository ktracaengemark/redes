									...
									<div class="row">														
										...
										<div class="col-md-10">
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">																				
													<a class="btn btn-md btn-success" href="<?php echo base_url() ?>relatoriofuncionario/clientes" role="button"> 
											...
											<div class="form-group col-md-10 text-left">	
												<div class="row">		
													<a class="btn btn-md btn-success" href="<?php echo base_url() ?>relatoriofuncionario/funcionario" role="button"> 
											...
											<div class="form-group col-md-10 text-left">	
												<div class="row">		
													<a class="btn btn-md btn-success" href="<?php echo base_url() ?>relatoriofuncionario/fornecedor" role="button"> 
										...
										<div class="col-md-10">											
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">													
													<a class="btn btn-md btn-info" href="<?php echo base_url() ?>relatoriofuncionario/clientes" role="button"> 
								...
								<div class="form-group">
									<div class="row">								
										<div class="col-md-10">											
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info" href="<?php echo base_url() ?>relatoriofuncionario/orcamento" role="button"> 
														<span class="glyphicon glyphicon-usd"></span> Orçamentos
													</a>											
												</div>	
											</div>											
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a  type="button" class="btn btn-md btn-info" href="<?php echo base_url() ?>relatoriofuncionario/despesas" role="button"> 
														<span class="glyphicon glyphicon-usd"></span> Despesas
													</a>
												</div>	
											</div>											
											<div class="form-group col-md-10 text-left">
												<div class="row">										
													<a  type="button" class="btn btn-md btn-info" href="<?php echo base_url() ?>relatoriofuncionario/receitas" role="button"> 
										...
										<div class="col-md-10">											
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatoriofuncionario/produtos" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatoriofuncionario/produtoscomp" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatoriofuncionario/produtosvend" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-primary" href="<?php echo base_url() ?>relatoriofuncionario/consumo" role="button"> 
										...
										<div class="col-md-10">
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">
													<a type="button" class="btn btn-md btn-warning" href="<?php echo base_url() ?>relatoriofuncionario/servicosprest" role="button"> 
											...
											<div class="form-group col-md-10 text-left">
												<div class="row">		
													<a type="button" class="btn btn-md btn-warning" href="<?php echo base_url() ?>relatoriofuncionario/orcamentopc" role="button"> 
