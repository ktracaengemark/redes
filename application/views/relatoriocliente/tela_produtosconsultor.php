		...
		<div class="col-md-10 ">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('relatoriocliente/produtoscliente', 'role="form"'); ?>
							...
							<div class="row">		
								...
								<div class="col-md-8 ">									
									...
									<div class="col-md-6 text-right">											
											<a class="btn btn-lg btn-danger" href="<?php echo base_url() ?>produtoscliente/cadastrar" role="button"> 
