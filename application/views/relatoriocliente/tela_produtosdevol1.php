			...
			<div class="main">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading"><strong><?php echo $titulo; ?></strong>
						...
						<?php echo form_open('relatoriocliente/produtosdevol1', 'role="form"'); ?>
						...
						<div class="text-left">
							...
							<a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>relatoriocliente/clientesusuario" role="button"> 
								<span class="glyphicon glyphicon-plus"></span> Nova Devol.
							</a>
						</div>
									...
									<div class="modal-footer">
										<div class="form-group text-left">
											...
											<div class="row">
												...
												<div class="col-md-3">
													<label for="DataInicio2">Dt Dev I:</label>
												...
												<div class="col-md-3">
													<label for="DataFim2">Dt Dev F:</label>
													<div class="input-group DatePicker">
														<span class="input-group-addon" disabled>
															<span class="glyphicon glyphicon-calendar"></span>
														</span>
