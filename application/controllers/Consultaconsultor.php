...
class Consultaconsultor extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Profissional_model', 'Consultaconsultor_model', 'Empresafilial_model', 'Cliente_model'));
    ...
    public function index() {
        ...
        $this->load->view('consultaconsultor/tela_index', $data);
...
*/
		...
		$data['select']['idApp_Agenda'] = $this->Basico_model->select_agendaconsultor();
		...
		#$data['select']['ContatoCliente'] = $this->Consultaconsultor_model->select_contatocliente_cliente($data['query']['idApp_Cliente']);
...
*/
        ...
        $data['form_open_path'] = 'consultaconsultor/cadastrar';
        $data['panel'] = 'primary';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['metodo'] = 1;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['idApp_Consulta'] = $this->Consultaconsultor_model->set_consulta($data['query']);
...
*/
    ...
    public function alterar($idApp_Consulta = FALSE) {
...
*/
        if ($idApp_Consulta) {
            #$data['query']['idApp_Cliente'] = $idApp_Cliente;
            $data['query'] = $this->Consultaconsultor_model->get_consulta($idApp_Consulta);
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['anterior'] = $this->Consultaconsultor_model->get_consulta($data['query']['idApp_Consulta']);
            $data['campos'] = array_keys($data['query']);
    ...
    public function listar($idApp_Cliente = NULL) {
        ...
        $data['query'] = array();
        $data['proxima'] = $this->Consultaconsultor_model->lista_consulta_proxima($idApp_Cliente);
        $data['anterior'] = $this->Consultaconsultor_model->lista_consulta_anterior($idApp_Cliente);
    ...
    public function excluir($id = FALSE) {
        ...
        if (!$id) {
            ...
            $data['anterior'] = $this->Consultaconsultor_model->get_consulta($id);
            #$data['campos'] = array_keys($data['query']);
            ...
            $this->Consultaconsultor_model->delete_consulta($id);
