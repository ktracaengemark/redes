...
class Agendafuncionario extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Agenda_model', 'Relatoriofuncionario_model'));
    ...
    public function index() {
        ...
        $data['select']['NomeUsuario'] = $this->Relatoriofuncionario_model->select_usuario();
		...
		$this->load->view('agendafuncionario/tela_agendafuncionario', $data);
