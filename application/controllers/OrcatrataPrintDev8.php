...
class OrcatrataPrintDev8 extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'OrcatrataPrintDev8_model', 'Profissional_model', 'Relatorio_model', 'Formapag_model', 'Consultor_model'));
    ...
    public function imprimir($id = FALSE) {
        ...
        if ($id) {
            #### App_OrcaTrata ####
            $data['orcatrata'] = $this->OrcatrataPrintDev8_model->get_orcatrata($id);
            ...
            $_SESSION['Orcatrata'] = $this->OrcatrataPrintDev8_model->get_orcatrata($data['orcatrata']['idApp_OrcaTrata'], TRUE);
			#$_SESSION['log']['idApp_Cliente'] = $_SESSION['Consultor']['idApp_Cliente'];

            /*
            #### App_ServicoVenda ####
            $data['servico'] = $this->OrcatrataPrintDev8_model->get_servico($id);
            ...
            */
            ...
            #### App_ProdutoVenda ####
            $data['produto'] = $this->OrcatrataPrintDev8_model->get_produto($id);
            ...
            $data['parcelasrec'] = $this->OrcatrataPrintDev8_model->get_parcelasrec($id);
            ...
            #### App_Procedimento ####
            $data['procedimento'] = $this->OrcatrataPrintDev8_model->get_procedimento($id);
        ...
        $this->load->view('orcatrata8/printdev_orcatrata8', $data);
