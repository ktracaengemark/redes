...
class Consultorassociado extends CI_Controller {
    ...
    public function cadastrar() {
        ...
        $data['titulo'] = 'Cadastrar Consultor Associado';
        $data['form_open_path'] = 'consultorassociado/cadastrar';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($data['idApp_Consultor'] === FALSE) {
				...
				*/
				...
				redirect(base_url() . 'relatorioconsultor/associado/' .  $data['msg']);
                exit();
            }
        }
