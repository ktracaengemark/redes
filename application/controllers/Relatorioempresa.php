...
class Relatorioempresa extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Profissional_model', 'Usuario_model', 'Relatorioempresa_model'));
...
*/
		...
		$data['select']['Nome'] = $this->Relatorioempresa_model->select_usuarioemp();
	...
	public function produtosempresa() {
        ...
        $data['select']['Produtos'] = $this->Relatorioempresa_model->select_produtosemp();
