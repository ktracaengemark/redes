...
*/
		...
		$data['select']['TipoReceita'] = $this->Relatoriofuncionario_model->select_tiporeceita();
		$data['select']['Mesvenc'] = $this->Relatoriofuncionario_model->select_mes();
		$data['select']['Mespag'] = $this->Relatoriofuncionario_model->select_mes();
		/*
        $data['select']['Pesquisa'] = array(
            'DataEntradaOrca' => 'Data de Entrada',
            'DataVencimentoRecebiveis' => 'Data de Vencimento da Parcela',
...
*/
	...
	public function devolucao1() {
		...
		*/
        ...
        $data['select']['Nome'] = $this->Relatoriofuncionario_model->select_clientes();
...
*/	   
		...
		$data['titulo'] = 'Aniversário dos Clientees';
