...
class Relatoriofuncionario extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Profissional_model', 'Cliente_model', 'Relatoriofuncionario_model'));
        ...
        #$this->load->view('relatoriofuncionario/nav_secundario');
    }
    ...
    public function index() {
        ...
        $this->load->view('relatoriofuncionario/tela_index', $data);
    ...
    public function financeiro() {
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_financeiro($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_financeiro', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_financeiro', $data);
	...
	public function receitas() {
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_receitas($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_receitas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_receitas', $data);
	...
	public function despesas1() {
		...
		*/
		...
		$data['select']['TipoDespesa'] = $this->Relatoriofuncionario_model->select_tipodespesa();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_despesas($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_despesas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_despesas', $data);
	...
	public function despesaspag() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_despesaspag($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_despesaspag', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_despesaspag', $data);
	...
	public function devolucao1DESPESAS() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_devolucao($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_devolucao', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_devolucao', $data);
    ...
    public function balanco() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_balanco($data['query']);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_balanco', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_balanco', $data);
    ...
    public function estoque() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_estoque($data['bd']);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_estoque', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_estoque', $data);
	...
	$data['select']['NomeCliente'] = $this->Relatoriofuncionario_model->select_cliente();
	$data['select']['idApp_Cliente'] = $this->Relatoriofuncionario_model->select_cliente();
	...
	if ($this->form_validation->run() !== FALSE) {
		...
		$data['report'] = $this->Relatoriofuncionario_model->list_rankingvendas($data['bd']);
		...
		$data['list'] = $this->load->view('relatoriofuncionario/list_rankingvendas', $data, TRUE);
		//$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
	}

	$this->load->view('relatoriofuncionario/tela_rankingvendas', $data);
	...
	public function admin() {
        ...
        $this->load->view('relatoriofuncionario/tela_admin', $data);
	...
	public function adminempresa() {
        ...
        $this->load->view('relatoriofuncionario/tela_adminempresa', $data);
	...
	public function sistema() {
        ...
        $this->load->view('relatoriofuncionario/tela_sistema', $data);
	...
	public function produtosvend() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['bd']['Campo'] = $data['query']['Campo'];
			$data['bd']['AprovadoOrca'] = $data['query']['AprovadoOrca'];
            $data['report'] = $this->Relatoriofuncionario_model->list_produtosvend($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_produtosvend', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_produtosvend', $data);
	...
	public function produtosdevol1() {
		...
		$data['select']['Nome'] = $this->Relatoriofuncionario_model->select_consultores();
		$data['select']['TipoDevolucao'] = $this->Relatoriofuncionario_model->select_tipodevolucao();
		$data['select']['Produtos'] = $this->Relatoriofuncionario_model->select_produtos();
		$data['select']['Prodaux1'] = $this->Relatoriofuncionario_model->select_prodaux1();
		$data['select']['Prodaux2'] = $this->Relatoriofuncionario_model->select_prodaux2();
		$data['select']['Prodaux3'] = $this->Relatoriofuncionario_model->select_prodaux3();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_produtosdevol1($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_produtosdevol1', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_produtosdevol1', $data);
	...
	public function servicosprest1() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_servicosprest($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_servicosprest', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_servicosprest', $data);
	...
	public function consumo() {
		...
		$data['select']['TipoDespesa'] = $this->Relatoriofuncionario_model->select_tipoconsumo();
		$data['select']['Produtos'] = $this->Relatoriofuncionario_model->select_produtos();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_consumo($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_consumo', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_consumo', $data);
	...
	public function produtoscomp() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_produtoscomp($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_produtoscomp', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_produtoscomp', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_produtosdevol($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_produtosdevol', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_produtosdevol', $data);
    ...
    public function orcamento() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_orcamento($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_orcamento', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_orcamento', $data);
	...
	public function devolucao1() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_devolucao1($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_devolucao1', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_devolucao1', $data);
	...
	public function despesas() {
		...
		*/
        ...
        $data['select']['NomeCliente'] = $this->Relatoriofuncionario_model->select_cliente();
		$data['select']['TipoDespesa'] = $this->Relatoriofuncionario_model->select_tipodespesa();
		$data['select']['Categoriadesp'] = $this->Relatoriofuncionario_model->select_categoriadesp();
    ...
    public function clientes() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_clientes($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_clientes', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_clientes', $data);
    ...
    public function clientesusuario() {
        ...
        $data['select']['Nome'] = $this->Relatoriofuncionario_model->select_clienteusuario();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_clientesusuario($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_clientesusuario', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_clientesusuario', $data);
	...
	public function consultores() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_consultores($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_consultores', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }
	...
	public function associado() {
        ...
        $data['select']['Nome'] = $this->Relatoriofuncionario_model->select_associado();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_associado($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_associado', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_associado', $data);
	...
	public function empresaassociado() {
        ...
        $data['select']['NomeEmpresa'] = $this->Relatoriofuncionario_model->select_empresaassociado();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_empresaassociado($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_empresaassociado', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_empresaassociado', $data);
	...
	public function profissionais() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_profissionais($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_profissionais', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_profissionais', $data);
	...
	public function funcionario() {
        ...
        $data['select']['Nome'] = $this->Relatoriofuncionario_model->select_funcionario();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_funcionario($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_funcionario', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_funcionario', $data);
	...
	public function empresas() {
        ...
        $data['select']['NomeEmpresa'] = $this->Relatoriofuncionario_model->select_empresas();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_empresas($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_empresas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_empresas', $data);
	...
	public function fornecedor() {
        ...
        $data['select']['NomeFornecedor'] = $this->Relatoriofuncionario_model->select_fornecedor();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_fornecedor($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_fornecedor', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_fornecedor', $data);
	...
	public function produtos() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_produtos($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_produtos', $data, TRUE);

        }

        $this->load->view('relatoriofuncionario/tela_produtos', $data);
	...
	public function servicos() {
        ...
        $data['select']['Servicos'] = $this->Relatoriofuncionario_model->select_servicos();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_servicos($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_servicos', $data, TRUE);

        }

        $this->load->view('relatoriofuncionario/tela_servicos', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_orcamentopc($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_orcamentopc', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_orcamentopc', $data);
...
*/
        ...
        $data['select']['NomeProfissional'] = $this->Relatoriofuncionario_model->select_profissional3();
		$data['select']['Profissional'] = $this->Relatoriofuncionario_model->select_profissional2();
		$data['select']['ObsTarefa'] = $this->Relatoriofuncionario_model->select_obstarefa();
		$data['select']['Procedtarefa'] = $this->Relatoriofuncionario_model->select_procedtarefa();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_tarefa($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_tarefa', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_tarefa', $data);
	...
	public function clienteprod() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_clienteprod($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_clienteprod', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_clienteprod', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatoriofuncionario_model->list_orcamentosv($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatoriofuncionario/list_orcamentosv', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatoriofuncionario/tela_orcamentosv', $data);
