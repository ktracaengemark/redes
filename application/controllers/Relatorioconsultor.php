...
class Relatorioconsultor extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Profissional_model', 'Cliente_model', 'Relatorioconsultor_model'));
        ...
        #$this->load->view('relatorioconsultor/nav_secundario');
    }
    ...
    public function index() {
        ...
        $this->load->view('relatorioconsultor/tela_index', $data);
    ...
    public function financeiro() {
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_financeiro($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_financeiro', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_financeiro', $data);
	...
	public function receitas() {
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_receitas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_receitas', $data);
    ...
    public function orcamento() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_orcamento($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_orcamento', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_orcamento', $data);
    ...
    public function orcamentorede() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_orcamentorede($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_orcamentorede', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_orcamentorede', $data);
	...
	public function despesas() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_despesas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_despesas', $data);
	...
	public function despesaspag() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_despesaspag($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_despesaspag', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_despesaspag', $data);
	...
	public function devolucao1DESPESAS() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_devolucao($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_devolucao', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_devolucao', $data);
    ...
    public function balanco() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_balanco($data['query']);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_balanco', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_balanco', $data);
    ...
    public function estoque() {
		...
		$data['select']['Prodaux3'] = $this->Relatorioconsultor_model->select_prodaux3();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_estoque($data['bd']);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_estoque', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_estoque', $data);
	...
	if ($this->form_validation->run() !== FALSE) {
		...
		$data['report'] = $this->Relatorioconsultor_model->list_rankingvendas($data['bd']);
		...
		$data['list'] = $this->load->view('relatorioconsultor/list_rankingvendas', $data, TRUE);
		//$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
	}

	$this->load->view('relatorioconsultor/tela_rankingvendas', $data);
	...
	public function admin() {
        ...
        $this->load->view('relatorioconsultor/tela_admin', $data);
	...
	public function adminempresa() {
        ...
        $this->load->view('relatorioconsultor/tela_adminempresa', $data);
	...
	public function sistema() {
        ...
        $this->load->view('relatorioconsultor/tela_sistema', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['bd']['Campo'] = $data['query']['Campo'];
			$data['bd']['AprovadoOrca'] = $data['query']['AprovadoOrca'];
            $data['report'] = $this->Relatorioconsultor_model->list_produtosvend($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_produtosvend', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_produtosvend', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_produtosdevol1', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_produtosdevol1', $data);
	...
	public function servicosprest1() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_servicosprest($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_servicosprest', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_servicosprest', $data);
	...
	public function consumo() {
		...
		$data['select']['TipoDespesa'] = $this->Relatorioconsultor_model->select_tipoconsumo();
		$data['select']['Produtos'] = $this->Relatorioconsultor_model->select_produtos();
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_consumo($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_consumo', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_consumo', $data);
	...
	public function produtoscomp() {
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_produtoscomp($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_produtoscomp', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_produtoscomp', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_produtosdevol($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_produtosdevol', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_produtosdevol', $data);
    ...
    public function devolucaorede() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_devolucaorede($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_devolucaorede', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_devolucaorede', $data);
	...
	public function devolucao1() {
		...
		*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_devolucao1($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_devolucao1', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_devolucao1', $data);
    ...
    public function clientes() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_clientes($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_clientes', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_clientes', $data);
    ...
    public function clientesusuario() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_clientesusuario($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_clientesusuario', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_clientesusuario', $data);
	...
	public function consultores() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_consultores($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_consultores', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_consultores', $data);
	...
	public function associado() {
		...
		$data['select']['Campo'] = array(
            'C.NomeConsultor' => 'Nome do Associado',
            'C.DataNascimento' => 'Data de Nascimento',
            'C.Sexo' => 'Sexo',
            'C.Email' => 'E-mail',
        );
        ...
        $data['select']['NomeConsultor'] = $this->Relatorioconsultor_model->select_associado();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_associado($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_associado', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_associado', $data);
	...
	public function associadopag() {
		...
		*/
		...
		$data['select']['NomeConsultor'] = $this->Relatorioconsultor_model->select_consultorassociado();
        ...
        */
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_associadopag($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_associadopag', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_associadopag', $data);
	...
	public function profissionais() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_profissionais($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_profissionais', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_profissionais', $data);
	...
	public function funcionario() {
        ...
        $data['select']['Nome'] = $this->Relatorioconsultor_model->select_funcionario();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_funcionario($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_funcionario', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_funcionario', $data);
	...
	public function empresas() {
        ...
        $data['select']['NomeEmpresa'] = $this->Relatorioconsultor_model->select_empresas();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_empresas($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_empresas', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_empresas', $data);
	...
	public function fornecedor() {
        ...
        $data['select']['NomeFornecedor'] = $this->Relatorioconsultor_model->select_fornecedor();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_fornecedor($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_fornecedor', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('profissional/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_fornecedor', $data);
	...
	public function produtos() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_produtos($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_produtos', $data, TRUE);

        }

        $this->load->view('relatorioconsultor/tela_produtos', $data);

        $this->load->view('basico/footer');

    }

	public function produtosconsultor() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_produtosconsultor($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_produtosconsultor', $data, TRUE);

        }

        $this->load->view('relatorioconsultor/tela_produtosconsultor', $data);
	...
	public function servicos() {
        ...
        $data['select']['Servicos'] = $this->Relatorioconsultor_model->select_servicos();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_servicos($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_servicos', $data, TRUE);

        }

        $this->load->view('relatorioconsultor/tela_servicos', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_orcamentopc($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_orcamentopc', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_orcamentopc', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_tarefa', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_tarefa', $data);
	...
	public function clienteprod() {
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_clienteprod($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_clienteprod', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_clienteprod', $data);
...
*/
        ...
        if ($this->form_validation->run() !== FALSE) {
            ...
            $data['report'] = $this->Relatorioconsultor_model->list_orcamentosv($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorioconsultor/list_orcamentosv', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorioconsultor/tela_orcamentosv', $data);
