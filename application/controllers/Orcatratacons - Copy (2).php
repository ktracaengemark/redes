...
class Orcatratacons extends CI_Controller {
    ...
    public function cadastrar($idApp_Cliente = NULL) {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            #### App_Cliente ####
            $data['orcatrata']['Associado'] = $data['orcatrata']['Associado'];
            $data['orcatrata']['idApp_Cliente'] = $this->Cliente_model->set_orcatrata($data['orcatrata']);
            ...
            if (isset($data['procedimento'])) {
                ...
                $data['procedimento']['idApp_ProcedimentoCons'] = $this->Cliente_model->set_procedimento($data['procedimento']);
            }
