...
class Orcatratadevcons extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('Basico_model', 'Orcatratadevcons_model', 'Tipodespesa_model', 'Profissional_model', 'Relatorio_model', 'Formapag_model', 'Consultor_model'));
...
*/
		...
		$data['select']['idApp_Cliente'] = $this->Consultor_model->select_consultor();
        $data['select']['Orcamento'] = $this->Basico_model->select_orcatratadevcons1();
        ...
        $data['form_open_path'] = 'orcatratadevcons/cadastrar';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 1;
        ...
        if ($this->form_validation->run() === FALSE) {
            //if (1 == 1) {
            $this->load->view('orcatratadevcons/form_orcatratadevcons', $data);
        } else {
            ...
            $data['orcatrata']['idApp_OrcaTrata'] = $this->Orcatratadevcons_model->set_orcatrata($data['orcatrata']);
            ...
            */
            ...
            if (isset($data['servico'])) {
                ...
                $data['servico']['idApp_ServicoVenda'] = $this->Orcatratadevcons_model->set_servico_venda($data['servico']);
            }
            ...
            if (isset($data['produto'])) {
                ...
                $data['produto']['idApp_ProdutoVenda'] = $this->Orcatratadevcons_model->set_produto_venda($data['produto']);
            }
            ...
            if (isset($data['parcelasrec'])) {
                ...
                $data['parcelasrec']['idApp_ParcelasRecebiveis'] = $this->Orcatratadevcons_model->set_parcelasrec($data['parcelasrec']);
            }
            ...
            if (isset($data['procedimento'])) {
                ...
                $data['procedimento']['idApp_Procedimento'] = $this->Orcatratadevcons_model->set_procedimento($data['procedimento']);
            }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if ($id) {
            #### App_OrcaTrata ####
            $data['orcatrata'] = $this->Orcatratadevcons_model->get_orcatrata($id);
            ...
            #### App_ServicoVenda ####
            $data['servico'] = $this->Orcatratadevcons_model->get_servico($id);
            ...
            #### App_ProdutoVenda ####
            $data['produto'] = $this->Orcatratadevcons_model->get_produto($id);
            ...
            $data['parcelasrec'] = $this->Orcatratadevcons_model->get_parcelasrec($id);
            ...
            #### App_Procedimento ####
            $data['procedimento'] = $this->Orcatratadevcons_model->get_procedimento($id);
        ...
        #$data['select']['Servico'] = $this->Basico_model->select_servicos();
        $data['select']['Produto'] = $this->Basico_model->select_produtos();
		$data['select']['Orcamento'] = $this->Basico_model->select_orcatratadevcons2();
		$data['select']['TipoDevolucao'] = $this->Tipodespesa_model->select_tipodevolucao();

        $data['titulo'] = 'Editar Devolução';
        $data['form_open_path'] = 'orcatratadevcons/alterar';
        $data['readonly'] = '';
        $data['disabled'] = '';
        $data['panel'] = 'primary';
        $data['metodo'] = 2;
        ...
        */
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['update']['orcatrata']['anterior'] = $this->Orcatratadevcons_model->get_orcatrata($data['orcatrata']['idApp_OrcaTrata']);
            ...
            $data['update']['orcatrata']['bd'] = $this->Orcatratadevcons_model->update_orcatrata($data['orcatrata'], $data['orcatrata']['idApp_OrcaTrata']);

            #### App_ServicoVenda ####
            $data['update']['servico']['anterior'] = $this->Orcatratadevcons_model->get_servico($data['orcatrata']['idApp_OrcaTrata']);
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                if (count($data['update']['servico']['inserir']))
                    $data['update']['servico']['bd']['inserir'] = $this->Orcatratadevcons_model->set_servico_venda($data['update']['servico']['inserir']);

                if (count($data['update']['servico']['alterar']))
                    $data['update']['servico']['bd']['alterar'] = $this->Orcatratadevcons_model->update_servico_venda($data['update']['servico']['alterar']);

                if (count($data['update']['servico']['excluir']))
                    $data['update']['servico']['bd']['excluir'] = $this->Orcatratadevcons_model->delete_servico_venda($data['update']['servico']['excluir']);
            }

            #### App_ProdutoVenda ####
            $data['update']['produto']['anterior'] = $this->Orcatratadevcons_model->get_produto($data['orcatrata']['idApp_OrcaTrata']);
            if (isset($data['produto']) || (!isset($data['produto']) && isset($data['update']['produto']['anterior']) ) ) {
                ...
                if (count($data['update']['produto']['inserir']))
                    $data['update']['produto']['bd']['inserir'] = $this->Orcatratadevcons_model->set_produto_venda($data['update']['produto']['inserir']);

                if (count($data['update']['produto']['alterar']))
                    $data['update']['produto']['bd']['alterar'] =  $this->Orcatratadevcons_model->update_produto_venda($data['update']['produto']['alterar']);

                if (count($data['update']['produto']['excluir']))
                    $data['update']['produto']['bd']['excluir'] = $this->Orcatratadevcons_model->delete_produto_venda($data['update']['produto']['excluir']);

            }

            #### App_ParcelasRec ####
            $data['update']['parcelasrec']['anterior'] = $this->Orcatratadevcons_model->get_parcelasrec($data['orcatrata']['idApp_OrcaTrata']);
            if (isset($data['parcelasrec']) || (!isset($data['parcelasrec']) && isset($data['update']['parcelasrec']['anterior']) ) ) {
                ...
                if (count($data['update']['parcelasrec']['inserir']))
                    $data['update']['parcelasrec']['bd']['inserir'] = $this->Orcatratadevcons_model->set_parcelasrec($data['update']['parcelasrec']['inserir']);

                if (count($data['update']['parcelasrec']['alterar']))
                    $data['update']['parcelasrec']['bd']['alterar'] =  $this->Orcatratadevcons_model->update_parcelasrec($data['update']['parcelasrec']['alterar']);

                if (count($data['update']['parcelasrec']['excluir']))
                    $data['update']['parcelasrec']['bd']['excluir'] = $this->Orcatratadevcons_model->delete_parcelasrec($data['update']['parcelasrec']['excluir']);

            }

            #### App_Procedimento ####
            $data['update']['procedimento']['anterior'] = $this->Orcatratadevcons_model->get_procedimento($data['orcatrata']['idApp_OrcaTrata']);
            if (isset($data['procedimento']) || (!isset($data['procedimento']) && isset($data['update']['procedimento']['anterior']) ) ) {
                ...
                if (count($data['update']['procedimento']['inserir']))
                    $data['update']['procedimento']['bd']['inserir'] = $this->Orcatratadevcons_model->set_procedimento($data['update']['procedimento']['inserir']);

                if (count($data['update']['procedimento']['alterar']))
                    $data['update']['procedimento']['bd']['alterar'] =  $this->Orcatratadevcons_model->update_procedimento($data['update']['procedimento']['alterar']);

                if (count($data['update']['procedimento']['excluir']))
                    $data['update']['procedimento']['bd']['excluir'] = $this->Orcatratadevcons_model->delete_procedimento($data['update']['procedimento']['excluir']);
...
*/
    ...
    public function excluir($id = FALSE) {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if (!$id) {
                ...
                /*
                $data['anterior'] = $this->Orcatratadevcons_model->get_orcatrata($data['query']['idApp_OrcaTrata']);
                ...
                */
                ...
                $this->Orcatratadevcons_model->delete_orcatrata($id);
    ...
    public function listar($id = NULL) {
        ...
        //$_SESSION['OrcaTrata'] = $this->Orcatratadevcons_model->get_cliente($id, TRUE);
        //$_SESSION['OrcaTrata']['idApp_Cliente'] = $id;
        $data['aprovado'] = $this->Orcatratadevcons_model->list_orcamento($id, 'S', TRUE);
        $data['naoaprovado'] = $this->Orcatratadevcons_model->list_orcamento($id, 'N', TRUE);
        ...
        $data['list'] = $this->load->view('orcatratadevcons/list_orcatratadevcons', $data, TRUE);
        $data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);

        $this->load->view('orcatratadevcons/list_orcatratadevcons', $data);
    ...
    public function listarBKP($id = NULL) {
        ...
        //$_SESSION['OrcaTrata'] = $this->Orcatratadevcons_model->get_cliente($id, TRUE);
        $_SESSION['OrcaTrata']['idApp_Cliente'] = $id;
        $data['query'] = $this->Orcatratadevcons_model->list_orcatrata(TRUE, TRUE);
        /*
          echo "<pre>";
          print_r($data['query']);
          echo "</pre>";
