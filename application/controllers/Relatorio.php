...
*/
	...
	public function consultores() {
        ...
        $data['select']['Nome'] = $this->Relatorio_model->select_consultores();
		#$data['select']['Inativo'] = $this->Relatorio_model->select_inativo();
        ...
        if ($this->form_validation->run() !== TRUE) {
            ...
            $data['report'] = $this->Relatorio_model->list_consultores($data['bd'],TRUE);
            ...
            $data['list'] = $this->load->view('relatorio/list_consultores', $data, TRUE);
            //$data['nav_secundario'] = $this->load->view('cliente/nav_secundario', $data, TRUE);
        }

        $this->load->view('relatorio/tela_consultores', $data);
