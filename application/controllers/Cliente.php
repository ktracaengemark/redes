...
class Cliente extends CI_Controller {
    ...
    public function cadastrar() {
        ...
        $this->form_validation->set_rules('Usuario', 'Usuário', 'required|trim|is_unique[App_Cliente.Usuario]');
		$this->form_validation->set_rules('NomeCliente', 'NomeCliente do Usuário', 'required|trim');
    ...
    public function alterar($id = FALSE) {
        ...
        #$this->form_validation->set_rules('NomeCliente', 'NomeCliente do Responsável', 'required|trim|is_unique_duplo[App_Cliente.NomeCliente.DataNascimento.' . $this->basico->mascara_data($data['query']['DataNascimento'], 'mysql') . ']');
        $this->form_validation->set_rules('NomeCliente', 'NomeCliente do Responsável', 'required|trim');
        $this->form_validation->set_rules('DataNascimento', 'Data de Nascimento', 'trim|valid_date');
        $this->form_validation->set_rules('DataExp', 'Data de Emissão', 'trim|valid_date');
		$this->form_validation->set_rules('Celular', 'Celular', 'required|trim');
