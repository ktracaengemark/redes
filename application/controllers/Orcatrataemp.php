...
*/
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data['orcatrata']['idSis_Empresa'] = $_SESSION['log']['id'];
            ...
            */
            ...
            if (isset($data['servico'])) {
                ...
                for($j=1;$j<=$max;$j++) {
                    $data['servico'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
            ...
            if (isset($data['produto'])) {
                ...
                for($j=1;$j<=$max;$j++) {
                    $data['produto'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
            ...
            if (isset($data['parcelasrec'])) {
                ...
                for($j=1;$j<=$max;$j++) {
                    $data['parcelasrec'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
            ...
            if (isset($data['procedimento'])) {
                ...
                for($j=1;$j<=$max;$j++) {
                    $data['procedimento'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if (isset($data['servico']) || (!isset($data['servico']) && isset($data['update']['servico']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    ...
                    $data['update']['servico']['inserir'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
            ...
            if (isset($data['produto']) || (!isset($data['produto']) && isset($data['update']['produto']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    $data['update']['produto']['inserir'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
            ...
            if (isset($data['parcelasrec']) || (!isset($data['parcelasrec']) && isset($data['update']['parcelasrec']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    $data['update']['parcelasrec']['inserir'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
            ...
            if (isset($data['procedimento']) || (!isset($data['procedimento']) && isset($data['update']['procedimento']['anterior']) ) ) {
                ...
                for($j=0;$j<$max;$j++) {
                    $data['update']['procedimento']['inserir'][$j]['idSis_Empresa'] = $_SESSION['log']['id'];
